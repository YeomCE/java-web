...
import { Box, Card, CardActionArea, Grid, Typography, Pagination } from "@mui/material"
...
export default function MyPageContents() {
    ...
    const { boardList, viewList, pageNumber, onPageHandler, COUNT, setBoardList } = usePagingHook();
